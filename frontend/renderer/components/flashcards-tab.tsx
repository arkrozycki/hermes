...
export function FlashcardsTab({ 
  ...
  const { sourceLanguage: sourceLang, targetLanguage: targetLang } = useLanguage()
  ...
  const TOTAL_DURATION = timers.source + timers.hidden + timers.translated + timers.pause
  ...
  return (
    <div className="h-full w-full overflow-y-auto bg-white">
      <div className="min-h-full flex items-start justify-center pt-8 pb-8">
        <Card className="p-8 text-center w-full max-w-2xl bg-white border-0 shadow-none">
        {componentState === 'selection' && (
          <div className="flex flex-col items-center space-y-6">
            ...
            {/* Advanced Settings */}
            <Collapsible open={isAdvancedOpen} onOpenChange={setIsAdvancedOpen} className="w-full max-w-md">
                ...
                <div className="text-left space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label className="text-sm font-medium flex justify-between">
                      ...
                      <span className="text-muted-foreground">{formatTime(timers.source)}</span>
                    </Label>
                    <Slider
                      value={[timers.source]}
                      onValueChange={(value) => handleTimerChange('source', value)}
                      max={5000}
                      min={500}
                      step={500}
                      className="w-full"
                    />
                    <p className="text-xs text-muted-foreground">How long to show the source word</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    <Label className="text-sm font-medium flex justify-between">
                      ...
                      <span className="text-muted-foreground">{formatTime(timers.hidden)}</span>
                    </Label>
                    <Slider
                      value={[timers.hidden]}
                      onValueChange={(value) => handleTimerChange('hidden', value)}
                      max={10000}
                      min={500}
                      step={500}
                      className="w-full"
                    />
                    <p className="text-xs text-muted-foreground">How long to hide the word (thinking time)</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    <Label className="text-sm font-medium flex justify-between">
                      ...
                      <span className="text-muted-foreground">{formatTime(timers.translated)}</span>
                    </Label>
                    <Slider
                      value={[timers.translated]}
                      onValueChange={(value) => handleTimerChange('translated', value)}
                      max={10000}
                      min={500}
                      step={500}
                      className="w-full"
                    />
                    <p className="text-xs text-muted-foreground">How long to show the translation</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    <Label className="text-sm font-medium flex justify-between">
                      ...
                      <span className="text-muted-foreground">{formatTime(timers.pause)}</span>
                    </Label>
                    <Slider
                      value={[timers.pause]}
                      onValueChange={(value) => handleTimerChange('pause', value)}
                      max={5000}
                      min={0}
                      step={500}
                      className="w-full"
                    />
                    <p className="text-xs text-muted-foreground">Pause between cards</p>
                  </div>
